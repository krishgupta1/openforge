...
const ProcessStep = ({
  ...
  <div className="flex gap-5 group">
    <div className="flex flex-col items-center">
      <div
        className={`w-8 h-8 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center ${statusColor} group-hover:border-zinc-600 transition-all z-10 shrink-0`}
      >
        {icon}
      </div>
      {!isLast && <div className="w-px flex-1 bg-zinc-800 my-2" />}
    </div>
    <div className="pb-8 pt-1">
      <h4
        className={`text-sm font-bold ${statusColor === "text-emerald-400" ? "text-emerald-400" : "text-white"}`}
      >
        {title}
      </h4>
...
// Recognition Card Component (Used for background blur effect)
const RecognitionCard = ({
  ...
  <div className="flex items-center justify-between p-3 rounded-xl bg-yellow-500/10 border border-yellow-500/20 opacity-50">
    <div className="flex items-center gap-3">
      <div className="w-9 h-9 rounded-full bg-yellow-500/20 flex items-center justify-center border border-yellow-500/30">
      ...
      <div className="flex flex-col">
        ...
        <span className="text-[10px] text-yellow-200/70">
          Contributed to{" "}
          <span className="font-semibold text-yellow-200">{project}</span>
        </span>
      </div>
    </div>
    <div className="p-2 rounded-lg bg-yellow-500/10 text-yellow-200/50">
      ...
      <div className="max-w-5xl mx-auto px-6 py-24">
        ...
        <div className="mb-20 pt-10">
          ...
          <p className="text-zinc-400 text-lg max-w-2xl leading-relaxed">
            Learn how to contribute, follow community rules, and collaborate
            smoothly to build something great together.
          </p>
        </div>
          ...
          <div className="p-8 bg-zinc-900/20 border border-zinc-800 rounded-2xl h-full">
            ...
            <div className="p-4 bg-red-500/10 border border-red-500/10 rounded-lg flex gap-3">
              ...
              <p className="text-xs text-red-200/80 leading-relaxed">
                <span className="font-bold text-red-400">Important:</span> Spam
          ...
          <div className="p-8 bg-zinc-900/20 border border-zinc-800 rounded-2xl h-full">
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={i}
                  className="flex items-center gap-3 p-4 rounded-lg bg-zinc-900/50 border border-zinc-800/50 hover:border-zinc-700/50 transition-colors"
                >
        ...
        <div className="mb-24">
          <div className="relative overflow-hidden bg-gradient-to-b from-zinc-900/50 to-transparent border border-zinc-800 rounded-2xl p-8 md:p-12 text-center">
            ...
            <p className="text-zinc-400 mb-8 max-w-lg mx-auto text-base">
              Connect with other developers, ask questions, and discuss ideas in
              our WhatsApp group.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20 items-start">
          ...
          <div className="flex flex-col h-full">
            ...
            {/* Content to match height of the right column */}
            <div className="pl-2 flex-1 flex flex-col justify-center h-full">
              <ProcessStep
          ...
          {/* 6. Recognition (BLURRED & COMING SOON) */}
          <div className="flex flex-col">
            <h3 className="text-lg font-bold text-white flex items-center gap-3 mb-8">
              <div className="p-1.5 rounded bg-zinc-900 border border-zinc-800">
            ...
            {/* Content to match height of the left column */}
            <div className="relative p-4 bg-yellow-500/5 border border-yellow-500/10 rounded-2xl flex flex-col overflow-hidden justify-start">
              {/* BLUR OVERLAY & COMING SOON TEXT */}
              <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-zinc-950/40 backdrop-blur-[6px]">
                <div className="px-5 py-2.5 rounded-full bg-zinc-900 border border-yellow-500/30 shadow-xl shadow-black/50 flex items-center gap-2">
              ...
              {/* Background (Blurred) Content - REDUCED ITEMS */}
              <div className="opacity-40 pointer-events-none select-none filter blur-[2px] flex flex-col justify-center h-full">
                <p className="text-sm text-yellow-200/80 mb-6 leading-relaxed">
                  Top contributors who successfully merge a PR get featured
                  here!
                </p>

                <div className="space-y-3">
                  <RecognitionCard name="Sahil Mishra" project="BullXchange" />
                  <RecognitionCard name="Krish Gupta" project="Babua LMS" />
                  {/* Removed 3rd card and footer link to reduce height */}
                </div>
              </div>
            </div>
          </div>
